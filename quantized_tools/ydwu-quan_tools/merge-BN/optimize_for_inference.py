...
# import optimize_for_inference_lib_lzwang
import optimize_for_inference_lib_klyu
# import optimize_for_inference_lib_ydwu
...
def main(unused_args):
  ...
  ### klyu
  output_graph_def = optimize_for_inference_lib_klyu.optimize_for_inference(
      input_graph_def,
      FLAGS.input_names.split(","),
      FLAGS.output_names.split(","), FLAGS.placeholder_type_enum)

  # ### ydwu
  # output_graph_def = optimize_for_inference_lib_ydwu.optimize_for_inference(
  #     input_graph_def,
  #     FLAGS.input_names.split(","),
  #     FLAGS.output_names.split(","), FLAGS.placeholder_type_enum)
